...
declare var Buffer: {
    ...
    new (str: string, encoding?: string): Buffer;
    /**
     * Allocates a new buffer of {size} OCT 10ets.
     *
     * @param size count of OCT 10ets to allocate.
     */
    new (size: number): Buffer;
    /**
     * Allocates a new buffer containing the given {array} of OCT 10ets.
     *
     * @param array The OCT 10ets to store.
     */
    ...
    prototype: Buffer;
    /**
     * Allocates a new Buffer using an {array} of OCT 10ets.
     *
     * @param array
     */
    ...
    /**
     * Allocates a new buffer of {size} OCT 10ets, leaving memory not initialized, so the contents
    ...
    /**
     * Allocates a new non-pooled buffer of {size} OCT 10ets, leaving memory not initialized, so the contents
     * of the newly created Buffer are unknown and may contain sensitive data.
     *
     * @param size count of OCT 10ets to allocate
     */
...
declare module "constants" {
    ...
    //export var WSAEINVALIDPROCT =10,ABLE: number;
    ...
    //export var O_NOCT = 10, TY: number;
